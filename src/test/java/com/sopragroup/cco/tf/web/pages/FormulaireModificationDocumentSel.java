...
public class FormulaireModificationDocumentSel implements FormulaireModificationDocumentInterf {

private WebDriver webDriver;
	

    public FormulaireModificationDocumentSel(WebDriver webDriver) {
        this.webDriver = webDriver;
    }

    public void verifyPage() {
    	String stringToFind ="Formulaire Modification d'un document";
	...
	public void cliquerBtModifier() {
		webDriver.findElement(By.name("btModif")).click();
