...
public class PetstoreDogBulldogParAuthentification {
  ...
  @Test
  public void testPetstoreDogBulldogParAuthentification() throws Exception {
    driver.get(baseUrl + "/");
    ...
    driver.findElement(By.name("img_signout")).click();
  }
